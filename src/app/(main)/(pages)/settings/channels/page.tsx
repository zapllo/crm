...
const TemplateCard = ({ template, onEdit, onDelete, onPreview, type = "email" }: {
  template: any;
      ...
      <div className="p-4 flex flex-col h-full">
        <div className="flex justify-between items-start mb-2">
          <div>
            ...
            {type === "email" && <p className="text-sm text-muted-foreground truncate">{template.subject}</p>}
          </div>
...
export default function ChannelsPage() {
  ...
  function openEditTemplateDialog(t: any) {
    ...
    setBody(t.body);
    setTemplateType("email"); // Assuming email for existing templates
    setOpenDialog(true);
  }
    ...
    <div className="p-6 space-y-8 overflow-y-scroll scrollbar-hide h-screen mx-auto">
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">
          Connect email and WhatsApp channels and manage your communication templates
        </p>
      </div>
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <Card className="border-green-100 dark:border-green-900 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border-b">
              ...
              <CardDescription>
                Connect your WhatsApp Business Account via Interakt
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 pt-6">
            ...
            <CardContent className="p-6">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
                <TabsList className="w-full bg-gray-100 dark:bg-gray-800">
                  ...
                  <TabsTrigger value="whatsapp" className="flex-1 gap-2" disabled={!connectedWaba}>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-12 space-y-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground max-w-md mx-auto">
                    Connect your WhatsApp Business Account to access and manage WhatsApp templates.
                  </p>
                </div>
        ...
        <DialogContent className="max-w-4xl h-fit max-h-screen overflow-y-scroll scrollbar-hide z-[100]">
          ...
          <DialogFooter className="flex flex-col sm:flex-row gap-3 sm:gap-0">
            ...
            <div className="flex gap-3">
              <Button variant="outline" onClick={() => handlePreviewTemplate({ name: templateName, subject, body, type: templateType })}>
                <Eye className="h-4 w-4 mr-2" />
                Preview
              </Button>
            ...
            {previewTemplate && (
              <>
                ...
                <Button
                  className="gap-2"
                  onClick={() => {
                    // Here you would implement sending test message
                  }}
                >
                  {previewTemplate.type === "whatsapp" ? (
                    <MessageCircle className="h-4 w-4" />
                  ...
                  Send Test {previewTemplate.type === "whatsapp" ? "Message" : "Email"}
                </Button>
              </>
            )}
          </DialogFooter>
