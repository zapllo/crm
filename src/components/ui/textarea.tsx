    ...
    return (
      <div className="relative w-full">
        ...
        {label && (
          <label
            className={cn(
              "absolute left-3 top-2 -mt-4 bg-white dark:bg-[#020713] px-1 text-xs text-gray-400 transition-all",
              // Peer-based classes:
        ...
        <textarea
          ref={ref}
          className={cn(
            "peer block w-full rounded border  bg-transparent px-3 py-2 dark:text-white shadow-sm placeholder:text-black text-sm placeholder-transparent",
